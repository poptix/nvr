...
def perform_object_detection(image, id):
    url = f"{settings.CODEPROJECT_HOST}/v1/vision/detection"
    ...
    if response.status_code == 200:
        ...
        for obj in response_data['predictions']:
            ...
            save_detected_objects_to_database(id, obj['label'], obj['x_min'], obj['x_max'], obj['y_min'], obj['y_max'], obj['confidence'], '')
        return 1 
    else:
